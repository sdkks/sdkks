...
| folor                      | Tail files recursively in a directory when they match a glob (_.log, _.jsonl, \*.ndlog) and including newly created files | [repo](https://github.com/sdkks/folor)                                                                            |
